...
for n_fEPSP = 1:n_fEPSPs
    ...
    % trough detection 
    [first_fEPSP_RoI_filtered_trough, first_fEPSP_RoI_filtered_trough_i] = findpeaks(-first_fEPSP_RoI_filtered, fs, 'MinPeakProminence', 0.002);
    ...
    [second_fEPSP_RoI_filtered_trough, second_fEPSP_RoI_filtered_trough_i] = findpeaks(-second_fEPSP_RoI_filtered, fs, 'MinPeakProminence', 0.002);
    ...
    [third_fEPSP_RoI_filtered_trough, third_fEPSP_RoI_filtered_trough_i] = findpeaks(-third_fEPSP_RoI_filtered, fs, 'MinPeakProminence', 0.002);
    ...
    % peak detection 
    [first_fEPSP_RoI_filtered_peak, first_fEPSP_RoI_filtered_peak_i] = findpeaks(first_fEPSP_RoI_filtered, fs, 'MinPeakProminence', 0.005, 'MinPeakDistance', 0.003);  % 필요시 Threshold 조절, 0.001s
    first_fEPSP_RoI_filtered_peak_i = first_fEPSP_RoI_filtered_peak_i * 1000 + first_fEPSP_RoI_t(1);
    [second_fEPSP_RoI_filtered_peak, second_fEPSP_RoI_filtered_peak_i] = findpeaks(second_fEPSP_RoI_filtered, fs, 'MinPeakProminence', 0.005, 'MinPeakDistance', 0.003);  % 필요시 Threshold 조절, 0.001s
    second_fEPSP_RoI_filtered_peak_i = second_fEPSP_RoI_filtered_peak_i * 1000 + second_fEPSP_RoI_t(1);
    [third_fEPSP_RoI_filtered_peak, third_fEPSP_RoI_filtered_peak_i] = findpeaks(third_fEPSP_RoI_filtered, fs, 'MinPeakProminence', 0.005, 'MinPeakDistance', 0.003);  % 필요시 Threshold 조절, 0.001s
    ...
    first_fEPSP_Amps  = [first_fEPSP_Amps, first_fEPSP_RoI_filtered_amp];
    second_fEPSP_Amps = [second_fEPSP_Amps, second_fEPSP_RoI_filtered_amp];
    third_fEPSP_Amps  = [third_fEPSP_Amps, third_fEPSP_RoI_filtered_amp];
    ...
    hold off;
    title(strcat("E45 - ", num2str(n_fEPSP), "V"));
    legend(["raw fEPSP", "LPF fEPSP(RoI)", "Stimulation", "Trough(RoI)", "Peak(RoI)", strcat("Amplitute = ", num2str(second_fEPSP_RoI_filtered_amp)), "Start Point"]);
    ylim([min_fEPSP_all, max_fEPSP_all]);
    xlabel("time(mS)");
    ylabel("fEPSP(mV)");
    ...
    hold off;
    title(strcat("E55 - ", num2str(n_fEPSP), "V"));
    legend(["raw fEPSP", "LPF fEPSP(RoI)", "Stimulation", "Trough(RoI)", "Peak(RoI)", strcat("Amplitute = ", num2str(third_fEPSP_RoI_filtered_amp)), "Start Point"]);
    ylim([min_fEPSP_all, max_fEPSP_all]);
    xlabel("time(mS)");
    ylabel("fEPSP(mV)");
    set(gcf, 'Units', 'normalized', 'OuterPosition', [0 0 1 1]);
